...
import com.example.administrator.newstitlexubotao.Adater.GridViewAdater;
import com.example.administrator.newstitlexubotao.R;
import com.example.administrator.newstitlexubotao.Uilt.MyGridView;
...
public class ChannelActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    private GridViewAdater mUserAdapter, mOtherAdapter;
    ...
    public void initView() {
        ...
        mOtherList.add("娱乐");
        mOtherList.add("探索");
        mUserAdapter = new GridViewAdater(this, mUserList,true);
        mOtherAdapter = new GridViewAdater(this, mOtherList,false);
        ...
        switch (parent.getId()) {
            case R.id.userGridView:
                ...
                if (position != 0 && position != 1) {
                    ...
                    if (moveImageView != null) {
                        ...
                        final String channel = ((GridViewAdater) parent.getAdapter()).getItem(position);//获取点击的频道内容
            ...
            case R.id.otherGridView:
                ...
                if (moveImageView != null) {
                    ...
                    final int[] startLocation = new int[2];
                    newTextView.getLocationInWindow(startLocation);
                    final String channel = ((GridViewAdater) parent.getAdapter()).getItem(position);
